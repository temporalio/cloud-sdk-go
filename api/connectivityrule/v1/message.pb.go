...
const file_temporal_api_cloud_connectivityrule_v1_message_proto_rawDesc = "" +
	"\n" +
	"4temporal/api/cloud/connectivityrule/v1/message.proto\x12&temporal.api.cloud.connectivityrule.v1\x1a,temporal/api/cloud/resource/v1/message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd7\x02\n" +
	"\x10ConnectivityRule\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12P\n" +
	"\x04spec\x18\x02 \x01(\v2<.temporal.api.cloud.connectivityrule.v1.ConnectivityRuleSpecR\x04spec\x12)\n" +
	"\x10resource_version\x18\x04 \x01(\tR\x0fresourceVersion\x12C\n" +
	"\x05state\x18\x05 \x01(\x0e2-.temporal.api.cloud.resource.v1.ResourceStateR\x05state\x12,\n" +
	"\x12async_operation_id\x18\x06 \x01(\tR\x10asyncOperationId\x12=\n" +
	"\fcreated_time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\vcreatedTimeJ\x04\b\x03\x10\x04\"\xf2\x01\n" +
	"\x14ConnectivityRuleSpec\x12a\n" +
	"\vpublic_rule\x18\x01 \x01(\v2>.temporal.api.cloud.connectivityrule.v1.PublicConnectivityRuleH\x00R\n" +
	"publicRule\x12d\n" +
	"\fprivate_rule\x18\x02 \x01(\v2?.temporal.api.cloud.connectivityrule.v1.PrivateConnectivityRuleH\x00R\vprivateRuleB\x11\n" +
	"\x0fconnection_type\"\x18\n" +
	"\x16PublicConnectivityRule\"\x82\x01\n" +
	"\x17PrivateConnectivityRule\x12#\n" +
	"\rconnection_id\x18\x01 \x01(\tR\fconnectionId\x12$\n" +
	"\x0egcp_project_id\x18\x02 \x01(\tR\fgcpProjectId\x12\x16\n" +
	"\x06region\x18\x03 \x01(\tR\x06regionJ\x04\b\x04\x10\x05B\xd4\x01\n" +
	")io.temporal.api.cloud.connectivityrule.v1B\fMessageProtoP\x01Z=go.temporal.io/api/cloud/connectivityrule/v1;connectivityrule\xaa\x02(Temporalio.Api.Cloud.ConnectivityRule.V1\xea\x02,Temporalio::Api::Cloud::ConnectivityRule::V1b\x06proto3"
