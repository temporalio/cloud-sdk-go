...
const file_temporal_api_cloud_cloudservice_v1_request_response_proto_rawDesc = "" +
	"\n" +
	"9temporal/api/cloud/cloudservice/v1/request_response.proto\x12\"temporal.api.cloud.cloudservice.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a-temporal/api/cloud/operation/v1/message.proto\x1a,temporal/api/cloud/identity/v1/message.proto\x1a-temporal/api/cloud/namespace/v1/message.proto\x1a)temporal/api/cloud/nexus/v1/message.proto\x1a*temporal/api/cloud/region/v1/message.proto\x1a+temporal/api/cloud/account/v1/message.proto\x1a)temporal/api/cloud/usage/v1/message.proto\x1a4temporal/api/cloud/connectivityrule/v1/message.proto\"\x81\x01\n" +
	...
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"\x9d\x02\n" +
	"\x16CreateNamespaceRequest\x12B\n" +
	"\x04spec\x18\x02 \x01(\v2..temporal.api.cloud.namespace.v1.NamespaceSpecR\x04spec\x12,\n" +
	"\x12async_operation_id\x18\x03 \x01(\tR\x10asyncOperationId\x12X\n" +
	"\x04tags\x18\x04 \x03(\v2D.temporal.api.cloud.cloudservice.v1.CreateNamespaceRequest.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	...
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"\x97\x02\n" +
	"'SetServiceAccountNamespaceAccessRequest\x12,\n" +
	"\x12service_account_id\x18\x01 \x01(\tR\x10serviceAccountId\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12G\n" +
	"\x06access\x18\x03 \x01(\v2/.temporal.api.cloud.identity.v1.NamespaceAccessR\x06access\x12)\n" +
	"\x10resource_version\x18\x04 \x01(\tR\x0fresourceVersion\x12,\n" +
	"\x12async_operation_id\x18\x05 \x01(\tR\x10asyncOperationId\"\x84\x01\n" +
	"(SetServiceAccountNamespaceAccessResponse\x12X\n" +
	...
	"#ValidateNamespaceExportSinkResponse\"\xc7\x02\n" +
	"\x1aUpdateNamespaceTagsRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12v\n" +
	"\x0etags_to_upsert\x18\x02 \x03(\v2P.temporal.api.cloud.cloudservice.v1.UpdateNamespaceTagsRequest.TagsToUpsertEntryR\ftagsToUpsert\x12$\n" +
	"\x0etags_to_remove\x18\x03 \x03(\tR\ftagsToRemove\x12,\n" +
	"\x12async_operation_id\x18\x04 \x01(\tR\x10asyncOperationId\x1a?\n" +
	"\x11TagsToUpsertEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"w\n" +
	"\x1bUpdateNamespaceTagsResponse\x12X\n" +
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"\x9f\x01\n" +
	"\x1dCreateConnectivityRuleRequest\x12P\n" +
	"\x04spec\x18\x01 \x01(\v2<.temporal.api.cloud.connectivityrule.v1.ConnectivityRuleSpecR\x04spec\x12,\n" +
	"\x12async_operation_id\x18\x02 \x01(\tR\x10asyncOperationId\"\xac\x01\n" +
	"\x1eCreateConnectivityRuleResponse\x120\n" +
	"\x14connectivity_rule_id\x18\x01 \x01(\tR\x12connectivityRuleId\x12X\n" +
	"\x0fasync_operation\x18\x02 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"N\n" +
	"\x1aGetConnectivityRuleRequest\x120\n" +
	"\x14connectivity_rule_id\x18\x01 \x01(\tR\x12connectivityRuleId\"\x84\x01\n" +
	"\x1bGetConnectivityRuleResponse\x12e\n" +
	"\x11connectivity_rule\x18\x01 \x01(\v28.temporal.api.cloud.connectivityrule.v1.ConnectivityRuleR\x10connectivityRule\"w\n" +
	"\x1bGetConnectivityRulesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\x12\x1c\n" +
	"\tnamespace\x18\x03 \x01(\tR\tnamespace\"\xaf\x01\n" +
	"\x1cGetConnectivityRulesResponse\x12g\n" +
	"\x12connectivity_rules\x18\x01 \x03(\v28.temporal.api.cloud.connectivityrule.v1.ConnectivityRuleR\x11connectivityRules\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xaa\x01\n" +
	"\x1dDeleteConnectivityRuleRequest\x120\n" +
	"\x14connectivity_rule_id\x18\x01 \x01(\tR\x12connectivityRuleId\x12)\n" +
	"\x10resource_version\x18\x02 \x01(\tR\x0fresourceVersion\x12,\n" +
	"\x12async_operation_id\x18\x03 \x01(\tR\x10asyncOperationId\"z\n" +
	"\x1eDeleteConnectivityRuleResponse\x12X\n" +
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"i\n" +
	"\"ValidateAccountAuditLogSinkRequest\x12C\n" +
	"\x04spec\x18\x01 \x01(\v2/.temporal.api.cloud.account.v1.AuditLogSinkSpecR\x04spec\"%\n" +
	"#ValidateAccountAuditLogSinkResponse\"\x95\x01\n" +
	" CreateAccountAuditLogSinkRequest\x12C\n" +
	"\x04spec\x18\x01 \x01(\v2/.temporal.api.cloud.account.v1.AuditLogSinkSpecR\x04spec\x12,\n" +
	"\x12async_operation_id\x18\x02 \x01(\tR\x10asyncOperationId\"}\n" +
	"!CreateAccountAuditLogSinkResponse\x12X\n" +
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"3\n" +
	"\x1dGetAccountAuditLogSinkRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"a\n" +
	"\x1eGetAccountAuditLogSinkResponse\x12?\n" +
	"\x04sink\x18\x01 \x01(\v2+.temporal.api.cloud.account.v1.AuditLogSinkR\x04sink\"\\\n" +
	"\x1eGetAccountAuditLogSinksRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"\x8c\x01\n" +
	"\x1fGetAccountAuditLogSinksResponse\x12A\n" +
	"\x05sinks\x18\x01 \x03(\v2+.temporal.api.cloud.account.v1.AuditLogSinkR\x05sinks\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xc0\x01\n" +
	" UpdateAccountAuditLogSinkRequest\x12C\n" +
	"\x04spec\x18\x01 \x01(\v2/.temporal.api.cloud.account.v1.AuditLogSinkSpecR\x04spec\x12)\n" +
	"\x10resource_version\x18\x02 \x01(\tR\x0fresourceVersion\x12,\n" +
	"\x12async_operation_id\x18\x03 \x01(\tR\x10asyncOperationId\"}\n" +
	"!UpdateAccountAuditLogSinkResponse\x12X\n" +
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperation\"\x8f\x01\n" +
	" DeleteAccountAuditLogSinkRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12)\n" +
	"\x10resource_version\x18\x02 \x01(\tR\x0fresourceVersion\x12,\n" +
	"\x12async_operation_id\x18\x03 \x01(\tR\x10asyncOperationId\"}\n" +
	"!DeleteAccountAuditLogSinkResponse\x12X\n" +
	"\x0fasync_operation\x18\x01 \x01(\v2/.temporal.api.cloud.operation.v1.AsyncOperationR\x0easyncOperationB\xc8\x01\n" +
