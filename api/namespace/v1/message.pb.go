...
const file_temporal_api_cloud_namespace_v1_message_proto_rawDesc = "" +
	"\n" +
	"-temporal/api/cloud/namespace/v1/message.proto\x12\x1ftemporal.api.cloud.namespace.v1\x1a,temporal/api/cloud/resource/v1/message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a(temporal/api/cloud/sink/v1/message.proto\x1a4temporal/api/cloud/connectivityrule/v1/message.proto\"\xc7\x01\n" +
	...
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\xda\x03\n" +
	"\x0fCodecServerSpec\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x12*\n" +
	"\x11pass_access_token\x18\x02 \x01(\bR\x0fpassAccessToken\x12G\n" +
	" include_cross_origin_credentials\x18\x03 \x01(\bR\x1dincludeCrossOriginCredentials\x12u\n" +
	"\x14custom_error_message\x18\x04 \x01(\v2C.temporal.api.cloud.namespace.v1.CodecServerSpec.CustomErrorMessageR\x12customErrorMessage\x1a\xbe\x01\n" +
	"\x12CustomErrorMessage\x12j\n" +
	"\adefault\x18\x01 \x01(\v2P.temporal.api.cloud.namespace.v1.CodecServerSpec.CustomErrorMessage.ErrorMessageR\adefault\x1a<\n" +
	"\fErrorMessage\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x12\n" +
	"\x04link\x18\x02 \x01(\tR\x04link\"I\n" +
	"\rLifecycleSpec\x128\n" +
	"\x18enable_delete_protection\x18\x01 \x01(\bR\x16enableDeleteProtection\"P\n" +
	"\x14HighAvailabilitySpec\x128\n" +
	"\x18disable_managed_failover\x18\x01 \x01(\bR\x16disableManagedFailover\"\xc0\n" +
	"\n" +
	...
	"\fcodec_server\x18\x06 \x01(\v20.temporal.api.cloud.namespace.v1.CodecServerSpecR\vcodecServer\x12L\n" +
	"\tlifecycle\x18\t \x01(\v2..temporal.api.cloud.namespace.v1.LifecycleSpecR\tlifecycle\x12b\n" +
	"\x11high_availability\x18\n" +
	" \x01(\v25.temporal.api.cloud.namespace.v1.HighAvailabilitySpecR\x10highAvailability\x122\n" +
	"\x15connectivity_rule_ids\x18\v \x03(\tR\x13connectivityRuleIds\x1aI\n" +
	...
	"\x10aws_private_link\x18\x02 \x01(\v23.temporal.api.cloud.namespace.v1.AWSPrivateLinkInfoR\x0eawsPrivateLink\"\xa8\t\n" +
	"\tNamespace\x12\x1c\n" +
	...
	"\rregion_status\x18\f \x03(\v2<.temporal.api.cloud.namespace.v1.Namespace.RegionStatusEntryR\fregionStatus\x12g\n" +
	"\x12connectivity_rules\x18\x0e \x03(\v28.temporal.api.cloud.connectivityrule.v1.ConnectivityRuleR\x11connectivityRules\x12H\n" +
	"\x04tags\x18\x0f \x03(\v24.temporal.api.cloud.namespace.v1.Namespace.TagsEntryR\x04tags\x1aw\n" +
	"\x11RegionStatusEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12L\n" +
	"\x05value\x18\x02 \x01(\v26.temporal.api.cloud.namespace.v1.NamespaceRegionStatusR\x05value:\x028\x01\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
