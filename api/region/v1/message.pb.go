...
const file_temporal_api_cloud_region_v1_message_proto_rawDesc = "" +
	"\n" +
	...
	"\x1fio.temporal.api.cloud.region.v1B\fMessageProtoP\x01Z)go.temporal.io/api/cloud/region/v1;region\xaa\x02\x1eTemporalio.Api.Cloud.Region.V1\xea\x02\"Temporalio::Api::Cloud::Region::V1b\x06proto3"
