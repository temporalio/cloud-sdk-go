...
const file_temporal_api_cloud_identity_v1_message_proto_rawDesc = "" +
	"\n" +
	...
	"\x04role\x18\x02 \x01(\x0e22.temporal.api.cloud.identity.v1.AccountAccess.RoleR\x04role\"\x8e\x01\n" +
	"\x04Role\x12\x14\n" +
	...
	"\x11ROLE_METRICS_READ\x10\x06\"\x91\x02\n" +
	...
	"!io.temporal.api.cloud.identity.v1B\fMessageProtoP\x01Z-go.temporal.io/api/cloud/identity/v1;identity\xaa\x02 Temporalio.Api.Cloud.Identity.V1\xea\x02$Temporalio::Api::Cloud::Identity::V1b\x06proto3"
