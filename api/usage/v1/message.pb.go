...
const file_temporal_api_cloud_usage_v1_message_proto_rawDesc = "" +
	"\n" +
	...
	"\x1eio.temporal.api.cloud.usage.v1B\fMessageProtoP\x01Z'go.temporal.io/api/cloud/usage/v1;usage\xaa\x02\x1dTemporalio.Api.Cloud.Usage.V1\xea\x02!Temporalio::Api::Cloud::Usage::V1b\x06proto3"
